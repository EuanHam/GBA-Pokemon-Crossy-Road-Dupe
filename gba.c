...
/*
    DMA Fixed Source - address for DMA transfer constant, read/write same location
    DMA Increment Source - address incremented between transfers (allow to read blocks of data)
*/
